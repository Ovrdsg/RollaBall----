...
namespace RollaBall
{
    ...
    public static class ExampleExtensions
    {
        ...
        //private static void ExampleTryBool(string value)
        //{
        ...
        private static void ExampleIsOneOf()
        {
            var arr = new[] { 1, 5, 6, 3 };
        ...
        public static T DeepCope<T>(this T self)
        {
            if(!typeof(T).IsSerializable)
            {
                throw new ArgumentNullException("Type must be iserializable");
            }
